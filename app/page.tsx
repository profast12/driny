...
<div style={{ position: 'relative' }} data-idioma="true">
  <button
    ...
    style={{ display: 'flex', alignItems: 'center', gap: '6px', padding: '7px 12px', borderRadius: '8px', border: '1.5px solid #e5e5e5', backgroundColor: 'white', cursor: 'pointer', fontSize: '13px', fontWeight: '600', color: '#555', transition: 'all 0.2s' }}
  ...
  {idiomaAbierto && (
    <div style={{ position: 'fixed', top: 'auto', right: '16px', backgroundColor: 'white', borderRadius: '14px', boxShadow: '0 8px 32px rgba(0,0,0,0.15)', border: '1px solid #eee', zIndex: 300, width: '200px', overflow: 'hidden', animation: 'slideDown 0.2s ease' }}>
      <div style={{ padding: '12px 14px', borderBottom: '1px solid #f5f5f5' }}>
        <p style={{ fontSize: '12px', fontWeight: '700', color: '#888', margin: 0, textTransform: 'uppercase', letterSpacing: '0.5px' }}>Selecciona idioma</p>
      </div>
      <div style={{ maxHeight: '300px', overflowY: 'auto' }}>
        {idiomas.map(idioma => (
          <button
            ...
            style={{ width: '100%', padding: '10px 14px', border: 'none', backgroundColor: 'transparent', cursor: 'pointer', textAlign: 'left', display: 'flex', alignItems: 'center', gap: '10px', fontSize: '13px', fontWeight: '600', color: '#333', transition: 'all 0.15s' }}
